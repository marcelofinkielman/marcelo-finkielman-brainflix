        ...
        <div className="hero__channelDateViewsLikes">
          ...
          <div className="hero__views-likes">
            <div className='hero__icon-and-number-1'>
              <img src={Views} alt='views' className="hero__views-icon" />
              <span className='hero__views'>
                {video.views}
              </span>
            </div>
            <div className='hero__icon-and-number-2'>
              <img src={Likes} alt='likes' className="hero__likes-icon" />
              <span className='hero__likes'>
                {video.likes}
              </span>
            </div>
          </div>
